...
rem 22.0 - Delphi 11
set DCC32="%ProgramFiles(x86)%\Embarcadero\Studio\20.0\bin\dcc32.exe" -B -GD -$R+ -$Q+ -$O- -H+ -W+ -W-SYMBOL_PLATFORM -DMM_%1 -AGenerics.Collections=System.Generics.Collections;Generics.Defaults=System.Generics.Defaults;WinTypes=Winapi.Windows;WinProcs=Winapi.Windows;DbiTypes=BDE;DbiProcs=BDE;DbiErrs=BDE -NSSystem.Win;Data.Win;Datasnap.Win;Web.Win;Soap.Win;Xml.Win;Bde;System;Xml;Data;Datasnap;Web;Soap;Winapi;Vcl;Vcl.Imaging;Vcl.Touch;Vcl.Samples;Vcl.Shell; -uMadExcept\Win32 MemoryManagerTest.dpr
set DCC64="%ProgramFiles(x86)%\Embarcadero\Studio\20.0\bin\dcc64.exe" -B -GD -$R+ -$Q+ -$O- -H+ -W+ -W-SYMBOL_PLATFORM -DMM_%1 -AGenerics.Collections=System.Generics.Collections;Generics.Defaults=System.Generics.Defaults;WinTypes=Winapi.Windows;WinProcs=Winapi.Windows;DbiTypes=BDE;DbiProcs=BDE;DbiErrs=BDE -NSSystem.Win;Data.Win;Datasnap.Win;Web.Win;Soap.Win;Xml.Win;Bde;System;Xml;Data;Datasnap;Web;Soap;Winapi;Vcl;Vcl.Imaging;Vcl.Touch;Vcl.Samples;Vcl.Shell; -uMadExcept\Win64 MemoryManagerTest.dpr
